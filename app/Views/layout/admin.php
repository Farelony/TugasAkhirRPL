...
<body>
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="/admin"><img src="<?= base_url() ?>/img/logo.png" style="width:220px; height:220px;margin-right:12px;margin-left: 8vw ;" alt=""></a>
            <h1>Admin</h1>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown" style="margin-left: 12px;" id="posisiFix">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="<?= base_url() ?>/img/user/default.png" style="width:64px; height:64px;object-fit: cover;" alt="">
                        </a>
